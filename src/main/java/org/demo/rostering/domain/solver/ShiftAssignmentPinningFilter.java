...
public class ShiftAssignmentPinningFilter implements PinningFilter<EmployeeRoster, ShiftAssignment> {
    ...
    public boolean accept(EmployeeRoster employeeRoster, ShiftAssignment shiftAssignment) {
        ...
        return !employeeRoster.getNurseRosterParametrization().isInPlanningWindow(shiftDate);
    }
