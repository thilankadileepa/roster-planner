...
package org.demo.rostering.solver.move.factory;
...
import org.demo.rostering.solver.move.EmployeeMultipleChangeMove;
...
public class ShiftAssignmentPillarPartSwapMoveFactory implements MoveListFactory<EmployeeRoster> {
    ...
    private PinningFilter<EmployeeRoster, ShiftAssignment> filter = new ShiftAssignmentPinningFilter();

    @Override
    public List<Move<EmployeeRoster>> createMoveList(EmployeeRoster employeeRoster) {
        ...
        shiftAssignmentList.removeIf(shiftAssignment -> filter.accept(employeeRoster, shiftAssignment));
        ...
        List<Move<EmployeeRoster>> moveList = new ArrayList<>();
    ...
    /**
     * TODO DRY with {@link org.demo.rostering.drools.EmployeeWorkSequence}.
     */
